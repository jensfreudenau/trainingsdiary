...
Garmin.DeviceDisplayDefaultOptions =
	...
	*/
	 ...
	 * @type String  */
	statusCellProcessingImg: '<img src="../javascripts/garmin/device/style/ajax-loader.gif" width="15" height="15" />',
	...
	load: function() {
		...
		.each(
			function(s) {
				...
				var dependencies = 'garmin/GarminDeviceControl' +
									',garmin/GarminDevicePlugin' +
